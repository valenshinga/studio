  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8 text-center">
        ...
        <h1 className="text-4xl font-bold tracking-tight">Nuestros Talentosos Profesores</h1>
        <p className="mt-2 text-lg text-muted-foreground">
          Conoce a los dedicados profesionales que hacen del aprendizaje de idiomas una experiencia atractiva.
        </p>
      </div>
      ...
      {filteredTeachers.length > 0 ? (
        ...
        <p className="text-center text-muted-foreground mt-10 text-lg">
          No se encontraron profesores que coincidan con tus criterios de búsqueda.
        </p>
      )}
    </div>
  );
